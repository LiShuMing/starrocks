...
class ConstColumn final : public COWHelper<ColumnFactory<Column, ConstColumn>, ConstColumn> {
    friend class COWHelper<ColumnFactory<Column, ConstColumn>, ConstColumn>;
...
public:
    ...
    MutableColumnPtr data_column_ptr() { return _data->assume_mutable(); }
