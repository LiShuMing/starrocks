...
using NullColumnMutablePtr = FixedLengthColumn<uint8_t>::MutablePtr;
using NullColumns = std::vector<NullColumnPtr>;
using NullColumnWrappedPtr = FixedLengthColumn<uint8_t>::DerivedWrappedPtr;
...
public:
    ...
    NullColumnMutablePtr null_column_mutable_ptr() {
