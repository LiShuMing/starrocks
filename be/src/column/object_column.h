...
template <typename T>
class ObjectColumn : public COWHelper<ColumnFactory<Column, ObjectColumn<T>>, ObjectColumn<T>> {
    friend class COWHelper<ColumnFactory<Column, ObjectColumn>, ObjectColumn>;
