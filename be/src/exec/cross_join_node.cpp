...
void CrossJoinNode::_copy_probe_rows_with_index_base_probe(MutableColumnPtr& dest_col, ColumnPtr& src_col,
...
void CrossJoinNode::_copy_probe_rows_with_index_base_build(MutableColumnPtr& dest_col, ColumnPtr& src_col,
                                                           size_t start_row, size_t copy_number) {
    if (src_col->is_nullable()) {
        if (src_col->is_constant()) {
            // current can't reach here
...
void CrossJoinNode::_copy_build_rows_with_index_base_probe(MutableColumnPtr& dest_col, ColumnPtr& src_col,
...
void CrossJoinNode::_copy_build_rows_with_index_base_build(MutableColumnPtr& dest_col, ColumnPtr& src_col,
                                                           size_t start_row, size_t row_count) {
    if (!src_col->is_nullable()) {
        if (src_col->is_constant()) {
            // current can't reach here
