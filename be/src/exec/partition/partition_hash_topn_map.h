...
protected:
    ...
    void append_chunk_for_one_key(HashMap& hash_map, const Columns& partition_columns, ChunkPtr chunk,
                                  KeyLoader&& key_loader, KeyAllocator&& key_allocator, ObjectPool* obj_pool,
    ...
    template <bool EnablePassthrough, bool EnablePreAgg, typename HashMap, typename KeyLoader, typename KeyAllocator,
              typename NewPartitionCallback, typename PartitionChunkConsumer, typename PartitionValidator>
    void append_chunk_for_one_nullable_key(HashMap& hash_map, const Columns& partition_columns,
                                           PartitionChunks& null_key_value, ChunkPtr chunk,
...
struct PartitionHashMapWithOneNumberKey : public PartitionHashMapBase<false, false> {
    ...
    bool append_chunk(ChunkPtr chunk, const Columns& key_columns, MemPool* mem_pool, ObjectPool* obj_pool,
        ...
        append_chunk_for_one_key<EnablePassthrough, EnablePreAgg>(
                hash_map, key_columns, chunk, [&](uint32_t offset) { return key_column_data[offset]; },
...
struct PartitionHashMapWithOneNullableNumberKey : public PartitionHashMapBase<true, false> {
    ...
    bool append_chunk(ChunkPtr chunk, const Columns& key_columns, MemPool* mem_pool, ObjectPool* obj_pool,
        ...
        append_chunk_for_one_nullable_key<EnablePassthrough, EnablePreAgg>(
                hash_map, key_columns, null_key_value, chunk, nullable_key_column,
...
struct PartitionHashMapWithOneStringKey : public PartitionHashMapBase<false, false> {
    ...
    bool append_chunk(ChunkPtr chunk, const Columns& key_columns, MemPool* mem_pool, ObjectPool* obj_pool,
        ...
        append_chunk_for_one_key<EnablePassthrough, EnablePreAgg>(
                hash_map, key_columns, chunk, [&](uint32_t offset) { return key_column->get_slice(offset); },
                [&](const Slice& key) {
...
struct PartitionHashMapWithSerializedKeyFixedSize : public PartitionHashMapBase<false, true> {
    ...
    bool append_chunk(ChunkPtr chunk, const Columns& key_columns, MemPool* mem_pool, ObjectPool* obj_pool,
        ...
        append_chunk_for_one_key<EnablePassthrough, EnablePreAgg>(
                hash_map, key_columns, chunk, [&](uint32_t offset) { return keys[offset]; },
