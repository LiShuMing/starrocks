...
/**
 * @brief  Combine combinator for aggregate function to combine the agg state to return the immediate result of aggregate function.
 ...
 */
class AggStateCombine final : public AggregateFunctionBatchHelper<AggStateCombineState, AggStateCombine> {
public:
