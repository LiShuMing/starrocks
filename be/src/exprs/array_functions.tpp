...
protected:
    ...
    static void _sort_array_column(Column* dest_array_column, std::vector<uint32_t>* sort_index,
        ...
        auto* dest_elements_column = down_cast<ArrayColumn*>(dest_array_column)->elements_column()->as_mutable_raw_ptr();
        auto* dest_offsets_column = down_cast<ArrayColumn*>(dest_array_column)->offsets_column()->as_mutable_raw_ptr();
...
private:
    ...
    static StatusOr<ColumnPtr> process(FunctionContext* context, const Columns& columns) {
        ...
        auto elements = array_col->elements_column()->as_mutable_raw_ptr();
