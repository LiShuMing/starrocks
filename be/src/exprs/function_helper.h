...
public:
     ...
     * @param v2 
     */
    static NullColumnMutablePtr union_nullable_column(const ColumnPtr& v1, const ColumnPtr& v2);
    ...
    static NullColumnMutablePtr union_null_column(const NullColumnPtr& v1, const NullColumnPtr& v2);
