...
const AggregateFunction* AggStateDesc::get_agg_state_func(AggStateDesc* agg_state_desc, bool is_result_nullable_hint) {
    DCHECK(agg_state_desc);
    bool is_result_nullable = agg_state_desc->is_result_nullable() || is_result_nullable_hint;
