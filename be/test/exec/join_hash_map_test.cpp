...
protected:
    ...
    static MutableColumnPtr create_column(LogicalType LT);
    static MutableColumnPtr create_column(LogicalType LT, uint32_t start, uint32_t count);
    static MutableColumnPtr create_nullable_column(LogicalType LT);
    static MutableColumnPtr create_nullable_column(LogicalType LT, const Buffer<uint8_t>& nulls, uint32_t start,
                                                   uint32_t count);
    ...
    void sort_results_from_coroutine(Buffer<uint32_t>& pid, Buffer<uint32_t>& bid, int size) {
        ...
        for (auto i = 0; i < size; i++) {
            zipped.emplace_back(pid[i], bid[i]);
        }
...
MutableColumnPtr JoinHashMapTest::create_column(LogicalType LT) {
...
MutableColumnPtr JoinHashMapTest::create_column(LogicalType LT, uint32_t start, uint32_t count) {
    if (LT == LogicalType::TYPE_INT) {
...
MutableColumnPtr JoinHashMapTest::create_nullable_column(LogicalType LT) {
    if (LT == LogicalType::TYPE_INT) {
...
MutableColumnPtr JoinHashMapTest::create_nullable_column(LogicalType LT, const Buffer<uint8_t>& nulls, uint32_t start,
                                                         uint32_t count) {
    if (LT == LogicalType::TYPE_INT) {
        auto data_column = FixedLengthColumn<int32_t>::create();
        auto null_column = FixedLengthColumn<uint8_t>::create();
...
TEST_F(JoinHashMapTest, DirectMappingJoinBuildProbeFunc) {
    ...
    auto result_data = down_cast<Int8Column*>(result_chunk->get_mutable_column_by_slot_id(1).get())->get_data();
...
TEST_F(JoinHashMapTest, DirectMappingJoinBuildProbeFuncNullable) {
    ...
    // check
    ASSERT_EQ(result_chunk->columns().size(), 2);
    auto* result_column = down_cast<NullableColumn*>(result_chunk->get_mutable_column_by_slot_id(1).get());
...
TEST_F(JoinHashMapTest, ProbeFromHtFirstOneToMany) {
    ...
    for (uint32_t i = 0; i < probe_state.count; i += 1) {
        results.emplace_back(probe_state.probe_index[i], probe_state.build_index[i]);
    }
...
TEST_F(JoinHashMapTest, OneKeyJoinHashTable) {
    ...
    auto column1 = result_chunk->get_mutable_column_by_slot_id(0);
    check_int32_column(*column1, 5, 1);
    auto column2 = result_chunk->get_mutable_column_by_slot_id(1);
    check_int32_column(*column2, 5, 11);
    auto column3 = result_chunk->get_mutable_column_by_slot_id(2);
    check_int32_column(*column3, 5, 21);
    auto column4 = result_chunk->get_mutable_column_by_slot_id(3);
    check_int32_column(*column4, 5, 1);
    auto column5 = result_chunk->get_mutable_column_by_slot_id(4);
    check_int32_column(*column5, 5, 11);
    auto column6 = result_chunk->get_mutable_column_by_slot_id(5);
...
TEST_F(JoinHashMapTest, EmptyHashMapTestLazyFilter) {
    ...
    auto c2 = result_chunk->get_mutable_column_by_slot_id(2);
    check_int32_column(*c2, 5, 21);
    auto c5 = result_chunk->get_mutable_column_by_slot_id(5);
    check_null_column(c5, 5);
    auto probe_index_col = result_chunk->get_mutable_column_by_slot_id(Chunk::HASH_JOIN_PROBE_INDEX_SLOT_ID);
    ...
    auto c1 = result_chunk->get_mutable_column_by_slot_id(1);
    c2 = result_chunk->get_mutable_column_by_slot_id(2);
    auto c4 = result_chunk->get_mutable_column_by_slot_id(4);
    c5 = result_chunk->get_mutable_column_by_slot_id(5);
...
TEST_F(JoinHashMapTest, NormalHashMapTestLazyOutputAll) {
    ...
    c2 = result_chunk->get_mutable_column_by_slot_id(2);
    c5 = result_chunk->get_mutable_column_by_slot_id(5);
    probe_index_col = result_chunk->get_mutable_column_by_slot_id(Chunk::HASH_JOIN_PROBE_INDEX_SLOT_ID);
    build_index_col = result_chunk->get_mutable_column_by_slot_id(Chunk::HASH_JOIN_BUILD_INDEX_SLOT_ID);
    ...
    c1 = result_chunk->get_mutable_column_by_slot_id(1);
    c2 = result_chunk->get_mutable_column_by_slot_id(2);
    c4 = result_chunk->get_mutable_column_by_slot_id(4);
    c5 = result_chunk->get_mutable_column_by_slot_id(5);
