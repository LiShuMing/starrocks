...
TEST_F(BinaryFunctionsTest, TestToBinaryNormal) {
    std::vector<std::tuple<BinaryFormatType, std::string, std::string>> good_cases = {
            {BinaryFormatType::HEX, "abab", "ABAB"},      {BinaryFormatType::HEX, "00", "00"},
            {BinaryFormatType::ENCODE64, "abab", "ABAB"}, {BinaryFormatType::ENCODE64, "00", "00"},
            {BinaryFormatType::UTF8, "abab", "ABAB"},     {BinaryFormatType::UTF8, "abab", "ABAB"},
            {BinaryFormatType::UTF8, "0", "0"},           {BinaryFormatType::UTF8, "0Xx", "0Xx"},
    };
