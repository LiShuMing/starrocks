...
Columns prepare_vector_vector(DecimalTestCaseArray const& test_cases, int lhs_precision, int lhs_scale,
    ...
    std::cout << "lhs_column=" << lhs_column->debug_string() << ", lhs_precision=" << lhs_precision
              << ",lhs_scale=" << lhs_scale << std::endl;
    std::cout << "rhs_column=" << rhs_column->debug_string() << ", rhs_precision=" << rhs_precision
              << ",rhs_scale=" << rhs_scale << std::endl;
