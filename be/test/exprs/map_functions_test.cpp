...
PARALLEL_TEST(MapFunctionsTest, test_distinct_map_keys) {
    ...
    { // nested map
        ...
        nest_keys->append_datum(1);
        nest_keys->append_datum(1);
        ColumnHelper::as_raw_column<FixedLengthColumn<int32_t>>(nest_offsets.get())->get_data().emplace_back(0);
        ColumnHelper::as_raw_column<FixedLengthColumn<int32_t>>(nest_offsets.get())->get_data().emplace_back(2);
        ColumnHelper::as_raw_column<FixedLengthColumn<int32_t>>(nest_offsets.get())->get_data().emplace_back(4);
