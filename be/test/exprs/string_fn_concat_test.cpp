...
TEST_F(StringFunctionConcatTest, concatConstOversizeTest) {
    ...
    Columns columns;
    columns.emplace_back(NullableColumn::create(std::move(col0), std::move(null_col)));
    columns.emplace_back(ConstColumn::create(std::move(col1), 1));
    columns.emplace_back(ConstColumn::create(std::move(col2), 1));
    columns.emplace_back(ConstColumn::create(std::move(col3), 1));
