...
void test_integral_pk() {
    ...
    auto pk_col = down_cast<FixedLengthColumn<DatumType>*>(chunk->get_mutable_column_by_index(0).get());
...
void test_binary_pk(int key_size) {
    ...
    auto pk_col = down_cast<BinaryColumn*>(chunk->get_mutable_column_by_index(0).get());
...
PARALLEL_TEST(PrimaryIndexTest, test_composite_key) {
    ...
    auto pk_col0 = down_cast<FixedLengthColumn<int8_t>*>(chunk->get_mutable_column_by_index(0).get());
    auto pk_col1 = down_cast<FixedLengthColumn<int16_t>*>(chunk->get_mutable_column_by_index(1).get());
