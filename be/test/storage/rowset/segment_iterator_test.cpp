...
TEST_F(SegmentIteratorTest, testBasicColumnHashIsCongruentFilter) {
...

    {
        ...
        auto binary_0 = down_cast<const BinaryColumn*>(res_chunk_mod_0->get_column_by_index(0).get());
...

    {
        ...
        auto binary_1 = down_cast<const BinaryColumn*>(res_chunk_mod_1->get_column_by_index(0).get());
...
TEST_F(SegmentIteratorTest, testCharToVarcharZoneMapFilter) {
    ...
    // Test 4: VARCHAR range predicate
    {
        ...
        auto int_col = down_cast<const Int32Column*>(res_chunk->get_column_by_index(0).get());
        auto varchar_col = down_cast<const BinaryColumn*>(res_chunk->get_column_by_index(1).get());
