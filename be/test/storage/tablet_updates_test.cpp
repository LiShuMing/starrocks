...
void TabletUpdatesTest::test_condition_update_apply(bool enable_persistent_index) {
    ...
    auto build_rowset = [&](std::vector<int64_t>& keys, std::vector<int32_t>& merge_column_data) -> RowsetSharedPtr {
        ...
        auto col0 = chunk->get_mutable_column_by_index(0);
        auto col1 = chunk->get_mutable_column_by_index(1);
        auto col2 = chunk->get_mutable_column_by_index(2);
    ...
    auto chunk = ChunkHelper::new_chunk(iter->schema(), 100);
    auto full_chunk = ChunkHelper::new_chunk(iter->schema(), keys.size());
    auto col0 = full_chunk->get_mutable_column_by_index(0);
    auto col1 = full_chunk->get_mutable_column_by_index(1);
    auto col2 = full_chunk->get_mutable_column_by_index(2);
