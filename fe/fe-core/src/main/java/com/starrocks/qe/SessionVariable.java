...
public class SessionVariable implements Serializable, Writable, Cloneable {
    ...
    public static final String ENABLE_MATERIALIZED_VIEW_VIEW_DELTA_REWRITE = "enable_materialized_view_view_delta_rewrite";
    public static final String ENABLE_RULE_BASED_MATERIALIZED_VIEW_REWRITE =
            "enable_rule_based_materialized_view_rewrite";

    public static final String MATERIALIZED_VIEW_CANDIDATES_MVS =
            "enable_materialized_view_candidates_mvs";
    ...
    @VarAttr(name = MATERIALIZED_VIEW_CANDIDATES_MVS)
    private String materializedViewCandidatesMVs = "";
    ...
    public String getMaterializedViewCandidatesMVs() {
        return materializedViewCandidatesMVs;
    }

    public void seMaterializedViewCandidatesMVs(String materializedViewCandidatesMVs) {
        this.materializedViewCandidatesMVs = materializedViewCandidatesMVs;
    }
