...
import com.starrocks.scheduler.mv.MVProcessorFactory;
...
public class MVRefreshProcessor extends BaseTaskRunProcessor implements MVRefreshExecutor {
    ...
    public void prepare(TaskRunContext context) throws Exception {
        ...
        this.logger = MVTraceUtils.getLogger(mv, MVRefreshProcessor.class);
        ...
        this.mvRefreshProcessor = MVProcessorFactory.INSTANCE.newProcessor(db, mv, mvTaskRunContext, mvMetricsEntity);
    ...
    public BaseMVRefreshProcessor getRefreshProcessor() {
