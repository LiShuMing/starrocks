...
public class PartitionBasedMvRefreshProcessor extends BaseMVRefreshProcessor {
    ...
    @Override
    protected Constants.TaskRunState doProcessTaskRun(TaskRunContext context) {
        ...
        Constants.TaskRunState result = doRefreshMaterializedViewWithRetry(context);
     ...
     */
    private boolean syncAndCheckPartitions(Map<BaseTableSnapshotInfo, Set<String>> baseTableCandidatePartitions)
     ...
     */
    private Constants.TaskRunState doRefreshMaterializedViewWithRetry(TaskRunContext taskRunContext) throws DmlException {
        ...
        while (refreshFailedTimes < maxRefreshMaterializedViewRetryNum &&
            ...
            try {
                ...
                return doRefreshMaterializedView(taskRunContext);
    ...
    private Constants.TaskRunState doRefreshMaterializedView(TaskRunContext context) throws Exception {
        ...
        Set<String> mvToRefreshedPartitions = null;
        Map<BaseTableSnapshotInfo, Set<String>> refTableRefreshPartitions = null;
