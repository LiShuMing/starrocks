...
public class MVRefreshListPartitioner extends MVRefreshPartitioner {
    private static final Logger LOG = LogManager.getLogger(MVRefreshListPartitioner.class);

    public MVRefreshListPartitioner(MvTaskRunContext mvContext,
