 ...
 */
public abstract class MVRefreshPartitioner {
    private static final Logger LOG = LogManager.getLogger(MVRefreshPartitioner.class);
    ...
    public MVRefreshPartitioner(MvTaskRunContext mvContext,
