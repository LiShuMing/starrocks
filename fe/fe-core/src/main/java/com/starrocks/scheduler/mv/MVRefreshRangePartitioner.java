...
public class MVRefreshRangePartitioner extends MVRefreshPartitioner {
    private static final int CREATE_PARTITION_BATCH_SIZE = 64;

    private static final Logger LOG = LogManager.getLogger(MVRefreshRangePartitioner.class);

    public MVRefreshRangePartitioner(MvTaskRunContext mvContext,
