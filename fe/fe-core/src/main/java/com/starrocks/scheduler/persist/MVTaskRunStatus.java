...
public class MVTaskRunStatus extends TaskRunStatus {
    ...
    public static MVTaskRunStatus read(DataInput in) throws IOException {
        String json = Text.readString(in);
        return GsonUtils.GSON.fromJson(json, MVTaskRunStatus.class);
    }
