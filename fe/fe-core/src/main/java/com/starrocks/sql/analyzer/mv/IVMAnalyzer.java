...
public class IVMAnalyzer {
     ...
     */
    private boolean rewriteImpl(QueryRelation queryRelation) {
    ...
    private boolean checkSubqueryRelation(SubqueryRelation subqueryRelation) {
    ...
    private boolean checkSelectRelation(SelectRelation selectRelation) {
    ...
    private boolean checkAggregate(SelectRelation selectRelation) {
        ...
        FunctionCallExpr rowIdFuncExpr = TvrOpUtils.buildRowIdFuncExprV2(groupByExprs);
