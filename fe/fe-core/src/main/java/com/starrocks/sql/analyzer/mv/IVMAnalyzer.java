...
public class IVMAnalyzer {
    ...
    private void checkSubqueryRelation(SubqueryRelation subqueryRelation) {
        QueryStatement subQueryStatement = subqueryRelation.getQueryStatement();
        rewriteImpl(subQueryStatement.getQueryRelation());
    ...
    private void checkSetRelation(SetOperationRelation setOperationRelation) {
    ...
    private void checkSelectRelation(SelectRelation selectRelation) {
        checkAggregate(selectRelation);
    ...
    private void checkRelation(Relation relation) {
        ...
        if (relation instanceof JoinRelation) {
            ...
            rewriteImpl(innerQueryRelation);
        } else {
    ...
    private void checkAggregate(SelectRelation selectRelation) {
