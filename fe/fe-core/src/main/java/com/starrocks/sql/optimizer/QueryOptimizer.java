...
import com.starrocks.sql.optimizer.rule.transformation.SplitTopNAggregateToJoinRule;
...
public class QueryOptimizer extends Optimizer {
    ...
    private OptExpression logicalRuleRewrite(
        ...
        scheduler.rewriteOnce(tree, rootTaskContext, new SplitTopNAggregateToJoinRule());
