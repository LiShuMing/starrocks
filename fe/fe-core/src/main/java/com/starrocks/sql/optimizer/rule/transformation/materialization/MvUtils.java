...
public class MvUtils {
    ...
    public static boolean isAppliedUnionAllRewrite(OptExpression optExpression) {
        if (optExpression == null) {
            return false;
        }
        if (isAppliedUnionAllRewrite(optExpression.getOp())) {
            return true;
        }
        for (OptExpression child : optExpression.getInputs()) {
            if (isAppliedUnionAllRewrite(child)) {
                return true;
            }
        }
        return false;
