...
public class TvrProjectRule extends TvrTransformationRule {
    ...
    public TvrProjectRule() {
        super(RuleType.TF_TVR_PROJECT, Pattern.create(OperatorType.LOGICAL_PROJECT, OperatorType.PATTERN_LEAF));
    }
    ...
    public OptExpression doTransform(OptExpression input,
        ...
        final TvrOptMeta tvrOptMeta = TvrOptMeta.ofChild(childTvrGroup, (childTvrOptExpression) -> {
            OptExpression result = OptExpression.create(projectOperator, childTvrOptExpression.optExpression());
