...
public abstract class TvrTransformationRule extends TransformationRule {
    ...
    /**
     * Do transformation on the input OptExpression to generate an incremental TvrOptExpression.
     */
    public abstract OptExpression doTransform(OptExpression input, OptimizerContext context);

    @Override
    public List<OptExpression> transform(OptExpression input, OptimizerContext context) {
        OptExpression result = doTransform(input, context);
