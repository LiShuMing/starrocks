...
privilegeType
    ...
    | PLUGIN | REPOSITORY| REFRESH | SELECT | UPDATE | USAGE | METRICS
    ;
...
nonReserved
    ...
    | METRICS | MASKING | MANUAL | MAP | MAPPING | MAPPINGS | MATERIALIZED | MAX | META | MIN | MINUTE | MODE | MODIFY | MONTH | MERGE | MINUS
