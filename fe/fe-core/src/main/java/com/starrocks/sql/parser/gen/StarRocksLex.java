...
public class StarRocksLex extends Lexer {
	...
	public static final int
		...
		USER=328, USING=329, VALUE=330, VALUES=331, VARBINARY=332, VARCHAR=333, 
		VARIABLES=334, VERBOSE=335, VIEW=336, WARNINGS=337, WEEK=338, WHEN=339, 
		WHERE=340, WHITELIST=341, WITH=342, WORK=343, WRITE=344, YEAR=345, EQ=346, 
		NEQ=347, LT=348, LTE=349, GT=350, GTE=351, EQ_FOR_NULL=352, PLUS_SYMBOL=353, 
		MINUS_SYMBOL=354, ASTERISK_SYMBOL=355, SLASH_SYMBOL=356, PERCENT_SYMBOL=357, 
		LOGICAL_OR=358, LOGICAL_AND=359, LOGICAL_NOT=360, INT_DIV=361, BITAND=362, 
		BITOR=363, BITXOR=364, BITNOT=365, ARROW=366, AT=367, INTEGER_VALUE=368, 
		DECIMAL_VALUE=369, DOUBLE_VALUE=370, SINGLE_QUOTED_TEXT=371, DOUBLE_QUOTED_TEXT=372, 
		BINARY_SINGLE_QUOTED_TEXT=373, BINARY_DOUBLE_QUOTED_TEXT=374, LETTER_IDENTIFIER=375, 
		DIGIT_IDENTIFIER=376, QUOTED_IDENTIFIER=377, BACKQUOTED_IDENTIFIER=378, 
		SIMPLE_COMMENT=379, BRACKETED_COMMENT=380, SEMICOLON=381, DOTDOTDOT=382, 
		WS=383;
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"WRITE", "YEAR", "EQ", "NEQ", "LT", "LTE", "GT", "GTE", "EQ_FOR_NULL", 
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'WHERE'", "'WHITELIST'", "'WITH'", "'WORK'", "'WRITE'", "'YEAR'", "'='", 
			null, "'<'", "'<='", "'>'", "'>='", "'<=>'", "'+'", "'-'", "'*'", "'/'", 
			"'%'", "'||'", "'&&'", "'!'", "'DIV'", "'&'", "'|'", "'^'", "'~'", "'->'", 
