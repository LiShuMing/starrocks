...
public class DropPartitionWithExprTest {
    private static final Logger LOG = LogManager.getLogger(DropPartitionWithExprTest.class);
    ...
    public static void beforeClass() throws Exception {
        ...
        TABLES_WITH_STRING_DT_TYPES = Lists.newArrayList(T1, T2, T3);
                ...
                (obj) -> {
...

                    {
                        try {
                            ...
                            Assert.assertTrue(e.getMessage().contains("Drop expression cannot be pruned, " +
                                    "please use other expressions"));
                        }
                        Assert.assertEquals(4, olapTable.getVisiblePartitions().size());
                    }
