...
import com.starrocks.scheduler.MVRefreshProcessor;
...
public abstract class MVTestBase extends StarRocksTestBase {
    ...
    protected MVRefreshProcessor withMVRefreshProcessor(String dbName, MaterializedView mv) throws Exception {
    ...
    protected static ExecPlan getMVRefreshExecPlan(TaskRun taskRun) throws Exception {
        ...
        Assertions.assertTrue(processor instanceof MVRefreshProcessor);
        MVRefreshProcessor mvRefreshProcessor = (MVRefreshProcessor) processor;
        MvTaskRunContext mvTaskRunContext = mvRefreshProcessor.getMvTaskRunContext();
    ...
    public static MVRefreshProcessor getMVRefreshProcessor(TaskRun taskRun) {
        Assertions.assertTrue(taskRun.getProcessor() instanceof MVRefreshProcessor);
        return (MVRefreshProcessor) taskRun.getProcessor();
    }
