        ...
        AGGREGATE ([GLOBAL] aggregate [{28: sum=sum(28: sum), 29: sum=sum(29: sum)}] group by [[24: l_shipmode]] having [null]
            EXCHANGE SHUFFLE[24]
                AGGREGATE ([LOCAL] aggregate [{28: sum=sum(26: case), 29: sum=sum(27: case)}] group by [[24: l_shipmode]] having [null]
                    SCAN (mv[lineitem_mv] columns[72: l_commitdate, 78: l_receiptdate, 80: l_shipdate, 82: l_shipmode, 86: o_orderpriority] predicate[78: l_receiptdate >= 1997-01-01 AND 78: l_receiptdate < 1998-01-01 AND 82: l_shipmode IN (REG AIR, MAIL) AND 72: l_commitdate < 78: l_receiptdate AND 80: l_shipdate < 72: l_commitdate])
[end]
