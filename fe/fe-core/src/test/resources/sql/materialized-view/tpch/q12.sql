        ...
        AGGREGATE ([GLOBAL] aggregate [{30: sum=sum(30: sum), 31: sum=sum(31: sum)}] group by [[25: L_SHIPMODE]] having [null]
            EXCHANGE SHUFFLE[25]
                AGGREGATE ([LOCAL] aggregate [{30: sum=sum(28: case), 31: sum=sum(29: case)}] group by [[25: L_SHIPMODE]] having [null]
                    SCAN (mv[lineitem_mv] columns[71: l_shipdate, 72: l_commitdate, 73: l_receiptdate, 75: l_shipmode, 91: o_orderpriority] predicate[73: l_receiptdate >= 1997-01-01 AND 73: l_receiptdate < 1998-01-01 AND 75: l_shipmode IN (REG AIR, MAIL) AND 72: l_commitdate < 73: l_receiptdate AND 71: l_shipdate < 72: l_commitdate])
[end]
