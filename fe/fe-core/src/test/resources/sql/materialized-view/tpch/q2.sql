        ...
        PREDICATE 22: PS_SUPPLYCOST = 164: min
            ANALYTIC ({164: min=min(22: PS_SUPPLYCOST)} [1: P_PARTKEY] [] )
                TOP-N (order by [[1: P_PARTKEY ASC NULLS FIRST]])
                    EXCHANGE SHUFFLE[1]
                        SCAN (mv[partsupp_mv] columns[59: ps_partkey, 63: ps_supplycost, 65: s_name, 66: s_address, 68: s_phone, 69: s_acctbal, 70: s_comment, 74: p_mfgr, 76: p_type, 77: p_size, 82: n_name, 86: r_name] predicate[77: p_size = 12 AND 86: r_name = AMERICA AND 76: p_type LIKE %COPPER])
[end]
