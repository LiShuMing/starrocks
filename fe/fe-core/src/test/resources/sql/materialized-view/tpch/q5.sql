        ...
        AGGREGATE ([GLOBAL] aggregate [{49: sum=sum(49: sum)}] group by [[42: n_name]] having [null]
            EXCHANGE SHUFFLE[42]
                AGGREGATE ([LOCAL] aggregate [{49: sum=sum(48: expr)}] group by [[42: n_name]] having [null]
                    SCAN (mv[lineitem_mv] columns[118: o_orderdate, 131: l_saleprice, 135: n_name1, 139: r_name1] predicate[139: r_name1 = AFRICA AND 118: o_orderdate >= 1995-01-01 AND 118: o_orderdate < 1996-01-01])
[end]
